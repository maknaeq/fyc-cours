...
|--------|------|-----------|
| Quentin Bauduin | Chef de projet, contenu transversal | Vidéos d'intro, études de cas, mise en commun, suivi |
| Kaan Topkaya | Parcours Laravel / PHP | Exemples, démos, code de départ et refactoring Laravel |
| Timothé Geoffroy | Parcours Spring / Java | Exemples, démos, code de départ et refactoring Spring |
| Erwin Gossin | Environnement & infrastructure | LLM local, clé API, démo ports/adapters |
